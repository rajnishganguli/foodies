...
# declarations can be accessed through a DBSession instance
...
# Clearing all the early data from the database
...
menuItem1 = MenuItem(name="Chicken Fried Steak",
...
menuItem2 = MenuItem(name="Boysenberry Sorbet",
...
menuItem3 = MenuItem(name="Broiled salmon",
...
menuItem4 = MenuItem(name="Morels on toast (seasonal)",
...
menuItem5 = MenuItem(name="Tandoori Chicken",
...
menuItem7 = MenuItem(name="Spinach Ice Cream",
...
menuItem3 = MenuItem(name="Lemon Curd Ice Cream Sandwich",
